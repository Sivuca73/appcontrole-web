...
export function MeetingMidweek({ meioSemana, mecanicas }: MeetingMidweekProps) {
  ...
  return (
    <div className="space-y-8" id="meio-semana-programacao-view">
      ...
      <div className="p-4 bg-green-50 border border-green-200 text-center rounded-xl text-xs text-green-700 font-semibold">
        [Isolamento Total] Se você está lendo isso, a reunião voltou e o erro é estritamente de importação ou sintaxe no arquivo MechanicalSupportGrid!
      </div>
    </div>
  );
}
